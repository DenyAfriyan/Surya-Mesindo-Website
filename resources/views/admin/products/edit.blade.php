    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_description') ? 'is-invalid' : '' }}" type="text" name="short_description" id="short_description" value="{{ old('short_description', $product->short_description) }}">
            ...
            <div class="form-group">
                <label for="cover">{{ trans('cruds.product.fields.cover') }}</label>
                <div class="needsclick dropzone {{ $errors->has('cover') ? 'is-invalid' : '' }}" id="cover-dropzone">
                </div>
                @if($errors->has('cover'))
                    <span class="text-danger">{{ $errors->first('cover') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.cover_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="termcondition">{{ trans('cruds.product.fields.termcondition') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('termcondition') ? 'is-invalid' : '' }}" name="termcondition" id="termcondition">{!! old('termcondition', $product->termcondition) !!}</textarea>
                @if($errors->has('termcondition'))
                    <span class="text-danger">{{ $errors->first('termcondition') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.termcondition_helper') }}</span>
            </div>
            <div class="form-group">
...
@if(isset($product) && $product->cover)
      var file = {!! json_encode($product->cover) !!}
          this.options.addedfile.call(this, file)
      this.options.thumbnail.call(this, file, file.preview ?? file.preview_url)
      file.previewElement.classList.add('dz-complete')
