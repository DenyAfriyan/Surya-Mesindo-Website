        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.team.fields.jobtitle') }}
                        </th>
                        <td>
                            {{ $team->jobtitle }}
                        </td>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.team.fields.photos') }}
                        </th>
                        <td>
                            @if($team->photos)
                                <a href="{{ $team->photos->getUrl() }}" target="_blank" style="display: inline-block">
                                    <img src="{{ $team->photos->getUrl('thumb') }}">
                                </a>
                            @endif
                        </td>
                    </tr>
