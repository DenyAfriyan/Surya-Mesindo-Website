    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.blogs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('likes') ? 'is-invalid' : '' }}" type="number" name="likes" id="likes" value="{{ old('likes', '0') }}" step="1">
                @if($errors->has('likes'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shares') ? 'is-invalid' : '' }}" type="number" name="shares" id="shares" value="{{ old('shares', '0') }}" step="1">
