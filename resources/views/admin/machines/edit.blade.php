    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.machines.update", [$machine->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $machine->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $machine->description) }}</textarea>
...
<script>
    ...
    init: function () {
@if(isset($machine) && $machine->image)
      var file = {!! json_encode($machine->image) !!}
